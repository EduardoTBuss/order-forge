...
usage() {
  cat <<'EOF'
Usage: scripts/compose-clean-cosmos.sh [--project <name>] [--compose-file <path>]

Removes the Cosmos DB volumes used by docker compose.
...
services=(cosmosdb cosmosdbviewer)
volumes=(
